            ...
            <div class="p-5">
              ...
              <form action="../../models/crudusers.php" method="post"  >
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="apellidosRegistro" placeholder="Apellidos" class="form-control form-control-user" required>
                   </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="password" name="passwordRegistro" placeholder="Password" class="form-control form-control-user" required>
                  </div>
                </div>
                <div class="form-group">
                  <input type="email"  name="emailRegistro" placeholder="Direccion Email " class="form-control form-control-user" required>
                </div>
